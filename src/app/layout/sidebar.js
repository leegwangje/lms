...
import { FaTachometerAlt, FaBookOpen, FaUserEdit, FaClipboardList, FaHistory, FaClipboardCheck, FaBullhorn, FaQuestionCircle, FaEnvelope } from 'react-icons/fa';
    ...
    <div className="sidebar">
      ...
      <ul>
        ...
        <li>
          <h3>Mypage</h3>
          <ul>
            <li><Link href="/mypage/current-courses"><FaBookOpen /> 수강하고 있는 강좌</Link></li>
